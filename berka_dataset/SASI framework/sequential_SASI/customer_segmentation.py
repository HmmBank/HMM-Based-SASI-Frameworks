...
# ====================================================
def initial_hmms_customers(customers, N, M, epsilon, minfloat):
...
# ====================================================
# 8. Constructing a HMM object with pomegranate 0.14.8
# ====================================================
...
# ===========================
def train_hmms(customers, initial_hmms, maxiter, minfloat, r, tolerance, file_hmm):
...
# ========================================
# 15. Calculating the scores for SA and SI
#     SA = Sequential Amounts
#     SI = Sequential Intensity
# =========================================
def compute_scores_SASI(customers, features, coefs_SI, coefs_SA, T_max, file_scores_SASI):
    ...
    for (phi, phi_bar), customer in zip(features, customers):  
        ...
        # Reduction of assymetry and robustness to outliers
...
def main():  
    ...
    parser = argparse.ArgumentParser(description="Customer segmentation using HMMs")
    ...
    parser.add_argument("--file_mc", type=str, default="./mc.dat", help="File containing the Markov chains of the customers")
    parser.add_argument("--file_hmm", type=str, default="./hmm.dat", help="File containing the HMMs of the customers")
    parser.add_argument("--csv_scores_SASI", type=str, default="./scores_SASI.csv", help="CSV file containing the scores (x,y) of the customers")
    ...
    initial_hmms = initial_hmms_customers(customers, nb_states, nb_symbols, epsilon, minfloat)

    # Customer HMM training
    features = train_hmms(customers, initial_hmms, maxiter, minfloat, r, tolerance, file_hmm)
    end_step = time.perf_counter()
    ...
    scores_SASI = compute_scores_SASI(customers, features, coefs_SI, coefs_SA, T_max, csv_scores_SASI)
    end_step = time.perf_counter()
    print(f"\nScore computation time: {end_step - start_step:g} s")

    # Building the ARFF customer file for clustering in Weka
    build_arff(customers, scores_SASI, arff_scores_SASI)
