...
__________________________________________________________________________________________________
   ...
   The current repository contains two directories: 
   "nigerian_dataset" and "berka_dataset", each containing the following subdirectories:
   
   1- RFM representations
   
   This directory contains the implementations and experimental data related 
   to the RFM-based representations investigated in [1] for the considered dataset.
   
   2- SASI framework
   
   This directory contains the implementations and experimental data related 
   to the SASI framework proposed and evaluated in [1] for the considered dataset.

   3- VAEs
   
   This directory contains the implementations and experimental data related 
   to the VAEs-based representations investigated in [1]  for the considered dataset.
__________________________________________________________________________________________________
   II- REQUIREMENTS
   ...
   * Important Note About "tslearn" *
   ...
   To execute the program "{dataset}\RFM representations\dynamic RFM\drfm.py" without 
...
__________________________________________________________________________________________________
   ...
   - the number of processors P for the parallel implementations,
   ...
   All PDF and HTML visualization files are stored in subdirectories named: 
   "visualization_files".  
_________________________________________________________________________________________________
    IV- Reference
	
[1] ????, and ????, "Efficient HMM-Based Interpretable Customer Representation 
                     for Customer Segmentation in Banking",(Under review).
__________________________________________________________________________________________________
